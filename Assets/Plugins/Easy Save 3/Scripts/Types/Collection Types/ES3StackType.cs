...
namespace ES3Types
{
    ...
    public class ES3StackType : ES3CollectionType
    {
        ...
        {
            var instance =
                (IList)ES3Reflection.CreateInstance(ES3Reflection.MakeGenericType(typeof(List<>), elementType.type));
            ...
            ES3Reflection.GetMethods(instance.GetType(), "Reverse").FirstOrDefault(t => !t.IsStatic)
