    ...
    internal class ES3ReflectedType : ES3Type
    {
        ...
        public override void Write(object obj, ES3Writer writer)
        {
            ...
            for (var i = 0; i < members.Length; i++)
            {
                ...
                if (ES3Reflection.IsAssignableFrom(typeof(Object), property.type))
                {
                    var valueObj = property.reflectedMember.GetValue(obj);
                    var value = valueObj == null ? null : (Object)valueObj;

                    writer.WritePropertyByRef(property.name, value);
                }
                else
                {
                    writer.WriteProperty(property.name, property.reflectedMember.GetValue(obj),
                        ES3TypeMgr.GetOrCreateES3Type(property.type));
                }
            }
        }
        ...
        public override object Read<T>(ES3Reader reader)
        {
            ...
            if (propertyName == ES3ReferenceMgrBase.referencePropertyName)
            {
                ...
                if (obj == null)
                {
                    ...
                    ES3ReferenceMgrBase.Current.Add((Object)obj, id);
                }
            }
            else
            {
