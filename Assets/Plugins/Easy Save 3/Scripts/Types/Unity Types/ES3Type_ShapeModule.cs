...
{
    [Preserve]
    [ES3PropertiesAttribute("enabled", "shapeType", "randomDirectionAmount", "sphericalDirectionAmount",
        "alignToDirection", "radius", "angle", "length", "box", "meshShapeType", "mesh", "meshRenderer",
        "skinnedMeshRenderer", "useMeshMaterialIndex", "meshMaterialIndex", "useMeshColors", "normalOffset",
        "meshScale", "arc")]
            ...
            while ((propertyName = reader.ReadPropertyName()) != null)
                switch (propertyName)
                {
                    ...
                    case "randomDirectionAmount":
                        instance.randomDirectionAmount = reader.Read<float>(ES3Type_float.Instance);
                        break;
                    case "sphericalDirectionAmount":
                        instance.sphericalDirectionAmount = reader.Read<float>(ES3Type_float.Instance);
                        break;
                    case "alignToDirection":
                        instance.alignToDirection = reader.Read<bool>(ES3Type_bool.Instance);
                        break;
                    case "radius":
                        instance.radius = reader.Read<float>(ES3Type_float.Instance);
                        break;
                    case "angle":
                        instance.angle = reader.Read<float>(ES3Type_float.Instance);
                        break;
                    case "length":
                        instance.length = reader.Read<float>(ES3Type_float.Instance);
                        break;
#if UNITY_5
					case "box":
                    ...
                    case "useMeshMaterialIndex":
                        instance.useMeshMaterialIndex = reader.Read<bool>(ES3Type_bool.Instance);
                        break;
                    case "meshMaterialIndex":
                        instance.meshMaterialIndex = reader.Read<int>(ES3Type_int.Instance);
                        break;
                    case "useMeshColors":
                        instance.useMeshColors = reader.Read<bool>(ES3Type_bool.Instance);
                        break;
                    case "normalOffset":
                        instance.normalOffset = reader.Read<float>(ES3Type_float.Instance);
                        break;
                    case "arc":
                        instance.arc = reader.Read<float>(ES3Type_float.Instance);
                        break;
                    default:
                        reader.Skip();
                        break;
