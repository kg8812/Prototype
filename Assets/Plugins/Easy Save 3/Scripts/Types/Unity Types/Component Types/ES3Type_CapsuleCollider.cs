...
{
    [Preserve]
    [ES3PropertiesAttribute("center", "radius", "height", "direction", "enabled", "isTrigger", "contactOffset",
        "sharedMaterial")]
    public class ES3Type_CapsuleCollider : ES3ComponentType
    {
        ...
        {
            var instance = (CapsuleCollider)obj;
        ...
        protected override void ReadComponent<T>(ES3Reader reader, object obj)
        {
            ...
            foreach (string propertyName in reader.Properties)
                ...
                {
                    case "center":
                        instance.center = reader.Read<Vector3>(ES3Type_Vector3.Instance);
                        break;
                    case "radius":
                    ...
                    case "isTrigger":
                        ...
                        break;
                    case "contactOffset":
                        instance.contactOffset = reader.Read<float>(ES3Type_float.Instance);
                        break;
                    case "material":
