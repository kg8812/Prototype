...
{
    [Preserve]
    [ES3PropertiesAttribute("duration", "loop", "prewarm", "startDelay", "startDelayMultiplier", "startLifetime",
        "startLifetimeMultiplier", "startSpeed", "startSpeedMultiplier", "startSize3D", "startSize",
        "startSizeMultiplier", "startSizeX", "startSizeXMultiplier", "startSizeY", "startSizeYMultiplier", "startSizeZ",
        "startSizeZMultiplier", "startRotation3D", "startRotation", "startRotationMultiplier", "startRotationX",
        "startRotationXMultiplier", "startRotationY", "startRotationYMultiplier", "startRotationZ",
        "startRotationZMultiplier", "randomizeRotationDirection", "startColor", "gravityModifier",
        "gravityModifierMultiplier", "simulationSpace", "customSimulationSpace", "simulationSpeed", "scalingMode",
    ...
    public class ES3Type_MainModule : ES3Type
    {
        ...
        {
            var instance = (ParticleSystem.MainModule)obj;
            ...
            writer.WriteProperty("gravityModifierMultiplier", instance.gravityModifierMultiplier,
        ...
        {
            var instance = new ParticleSystem.MainModule();
        ...
        public override void ReadInto<T>(ES3Reader reader, object obj)
        {
            ...
            while ((propertyName = reader.ReadPropertyName()) != null)
                ...
                {
                    case "duration":
                        instance.duration = reader.Read<float>(ES3Type_float.Instance);
                        break;
                    case "loop":
                        instance.loop = reader.Read<bool>(ES3Type_bool.Instance);
                        break;
                    case "prewarm":
                        instance.prewarm = reader.Read<bool>(ES3Type_bool.Instance);
                        break;
                    case "startDelay":
                        instance.startDelay = reader.Read<ParticleSystem.MinMaxCurve>(ES3Type_MinMaxCurve.Instance);
                        break;
                    case "startDelayMultiplier":
                        instance.startDelayMultiplier = reader.Read<float>(ES3Type_float.Instance);
                        break;
                    case "startLifetime":
                        instance.startLifetime = reader.Read<ParticleSystem.MinMaxCurve>(ES3Type_MinMaxCurve.Instance);
                        break;
                    case "startLifetimeMultiplier":
                        instance.startLifetimeMultiplier = reader.Read<float>(ES3Type_float.Instance);
                        break;
                    case "startSpeed":
                        instance.startSpeed = reader.Read<ParticleSystem.MinMaxCurve>(ES3Type_MinMaxCurve.Instance);
                        break;
                    case "startSpeedMultiplier":
                        instance.startSpeedMultiplier = reader.Read<float>(ES3Type_float.Instance);
                        break;
                    case "startSize3D":
                        instance.startSize3D = reader.Read<bool>(ES3Type_bool.Instance);
                        break;
                    case "startSize":
                        instance.startSize = reader.Read<ParticleSystem.MinMaxCurve>(ES3Type_MinMaxCurve.Instance);
                        break;
                    case "startSizeMultiplier":
                        instance.startSizeMultiplier = reader.Read<float>(ES3Type_float.Instance);
                        break;
                    case "startSizeX":
                        instance.startSizeX = reader.Read<ParticleSystem.MinMaxCurve>(ES3Type_MinMaxCurve.Instance);
                        break;
                    case "startSizeXMultiplier":
                        instance.startSizeXMultiplier = reader.Read<float>(ES3Type_float.Instance);
                        break;
                    case "startSizeY":
                        instance.startSizeY = reader.Read<ParticleSystem.MinMaxCurve>(ES3Type_MinMaxCurve.Instance);
                        break;
                    case "startSizeYMultiplier":
                        instance.startSizeYMultiplier = reader.Read<float>(ES3Type_float.Instance);
                        break;
                    case "startSizeZ":
                        instance.startSizeZ = reader.Read<ParticleSystem.MinMaxCurve>(ES3Type_MinMaxCurve.Instance);
                        break;
                    case "startSizeZMultiplier":
                        instance.startSizeZMultiplier = reader.Read<float>(ES3Type_float.Instance);
                        break;
                    case "startRotation3D":
                        instance.startRotation3D = reader.Read<bool>(ES3Type_bool.Instance);
                        break;
                    case "startRotation":
                        instance.startRotation = reader.Read<ParticleSystem.MinMaxCurve>(ES3Type_MinMaxCurve.Instance);
                        break;
                    case "startRotationMultiplier":
                        instance.startRotationMultiplier = reader.Read<float>(ES3Type_float.Instance);
                        break;
                    case "startRotationX":
                        instance.startRotationX = reader.Read<ParticleSystem.MinMaxCurve>(ES3Type_MinMaxCurve.Instance);
                        break;
                    case "startRotationXMultiplier":
                        instance.startRotationXMultiplier = reader.Read<float>(ES3Type_float.Instance);
                        break;
                    case "startRotationY":
                        instance.startRotationY = reader.Read<ParticleSystem.MinMaxCurve>(ES3Type_MinMaxCurve.Instance);
                        break;
                    case "startRotationYMultiplier":
                        instance.startRotationYMultiplier = reader.Read<float>(ES3Type_float.Instance);
                        break;
                    case "startRotationZ":
                        instance.startRotationZ = reader.Read<ParticleSystem.MinMaxCurve>(ES3Type_MinMaxCurve.Instance);
                        break;
                    case "startRotationZMultiplier":
                        instance.startRotationZMultiplier = reader.Read<float>(ES3Type_float.Instance);
                        break;
#if UNITY_2018_1_OR_NEWER
                    case "flipRotation":
                        instance.flipRotation = reader.Read<float>(ES3Type_float.Instance);
                        break;
                    ...
                    case "startColor":
                        instance.startColor =
                            reader.Read<ParticleSystem.MinMaxGradient>(ES3Type_MinMaxGradient.Instance);
                        break;
                    case "gravityModifier":
                        instance.gravityModifier =
                            reader.Read<ParticleSystem.MinMaxCurve>(ES3Type_MinMaxCurve.Instance);
                        break;
                    case "gravityModifierMultiplier":
                        instance.gravityModifierMultiplier = reader.Read<float>(ES3Type_float.Instance);
                        break;
                    case "simulationSpace":
                        instance.simulationSpace = reader.Read<ParticleSystemSimulationSpace>();
                        break;
                    case "customSimulationSpace":
                        instance.customSimulationSpace = reader.Read<Transform>(ES3Type_Transform.Instance);
                        break;
                    case "simulationSpeed":
                        instance.simulationSpeed = reader.Read<float>(ES3Type_float.Instance);
                        break;
                    case "scalingMode":
                        instance.scalingMode = reader.Read<ParticleSystemScalingMode>();
                        break;
                    case "playOnAwake":
                        instance.playOnAwake = reader.Read<bool>(ES3Type_bool.Instance);
                        break;
                    case "maxParticles":
                        instance.maxParticles = reader.Read<int>(ES3Type_int.Instance);
                        break;
                    default:
                        reader.Skip();
                        break;
