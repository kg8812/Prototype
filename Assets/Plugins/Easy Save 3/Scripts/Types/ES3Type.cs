...
namespace ES3Types
{
    ...
    public abstract class ES3Type
    {
        ...
        internal string ReadPropertyName(ES3Reader reader)
        {
            ...
            {
                var propertyName = reader.overridePropertiesName;
        ...
        protected void WriteProperties(object obj, ES3Writer writer)
        {
            ...
            for (var i = 0; i < members.Length; i++)
            {
                ...
                writer.WriteProperty(property.name, property.reflectedMember.GetValue(obj),
                    ES3TypeMgr.GetOrCreateES3Type(property.type), writer.settings.memberReferenceMode);
            }
        }
        ...
        protected object ReadProperties(ES3Reader reader, object obj)
        {
            ...
            foreach (string propertyName in reader.Properties)
            {
                ...
                else
                {
                    ...
                    {
                        var readObj = reader.Read<object>(type);
        ...
        protected void GetMembers(bool safe, string[] memberNames)
        {
            ...
            for (var i = 0; i < serializedMembers.Length; i++)
