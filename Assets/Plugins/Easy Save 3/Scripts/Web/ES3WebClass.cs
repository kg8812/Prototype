...
namespace ES3Internal
{
    public class ES3WebClass
    {
        ...
        protected List<KeyValuePair<string, string>> formData = new();
        ...
        /// <summary>
        ///     Adds POST data to any requests sent by this ES3Cloud object. Use this if you are sending data to a custom
        ...
        public bool isError => !string.IsNullOrEmpty(error) || errorCode > 0;

        /// <summary>
        ///     The error code relating to the error, if one occurred. If it's a server error, this will return the HTTP error
        ///     code.
        /// </summary>
