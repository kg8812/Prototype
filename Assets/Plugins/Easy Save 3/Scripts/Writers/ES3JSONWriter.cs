...
namespace ES3Internal
{
    internal class ES3JSONWriter : ES3Writer
    {
        ...
        internal ES3JSONWriter(Stream stream, ES3Settings settings, bool writeHeaderAndFooter, bool mergeKeys) : base(
            settings, writeHeaderAndFooter, mergeKeys)
        {
        ...
        public void WriteNewlineAndTabs()
        {
            if (settings.prettyPrint)
            {
                ...
                for (var i = 0; i < serializationDepth; i++)
                    baseWriter.Write('\t');
            }
        }
