...
namespace ES3Editor
{
    public class HomeWindow : SubWindow
    {
        ...
        public override void OnGUI()
        {
            ...
            EditorGUILayout.BeginVertical(style.area);
            ES3EditorUtility.DisplayLink("• See our Getting Started guide",
            ...
            ES3EditorUtility.DisplayLink("• Ask a question in our Easy Save 3 forums",
                "http://moodkie.com/forum/viewforum.php?f=12");
            ES3EditorUtility.DisplayLink("• Ask a question in the Unity Forum thread",
                "https://forum.unity3d.com/threads/easy-save-the-complete-save-load-asset-for-unity.91040/");
            EditorGUILayout.EndVertical();
            ...
            ES3EditorUtility.DisplayLink("• API Scripting Reference",
                "http://docs.moodkie.com/product/easy-save-3/es3-api/");
            ES3EditorUtility.DisplayLink("• Supported Types",
            ...
            ES3EditorUtility.DisplayLink("• Actions",
                "http://docs.moodkie.com/product/easy-save-3/es3-playmaker/es3-playmaker-actions/");
            ES3EditorUtility.DisplayLink("• Actions Overview",
                "http://docs.moodkie.com/easy-save-3/es3-playmaker/playmaker-actions-overview/");
