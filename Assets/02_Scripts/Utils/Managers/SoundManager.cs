...
namespace Default
{
    public class SoundManager
    {
        ...
        public void Init()
        {
            if (_audioMixer == null) _audioMixer = ResourceUtil.Load<AudioMixer>("SoundMixer");
            ...
            _baseAudioSource[(int)Define.Sound.BGM].outputAudioMixerGroup =
                ResourceUtil.Load<AudioMixerGroup>("SoundMixer[BGM]");
            _baseAudioSource[(int)Define.Sound.SFX].outputAudioMixerGroup =
                ResourceUtil.Load<AudioMixerGroup>("SoundMixer[SFX]");
            _baseAudioSource[(int)Define.Sound.UI].outputAudioMixerGroup =
                ResourceUtil.Load<AudioMixerGroup>("SoundMixer[UI]");
            _baseAudioSource[(int)Define.Sound.Ambience].outputAudioMixerGroup =
                ResourceUtil.Load<AudioMixerGroup>("SoundMixer[Ambience]");
            _baseAudioSource[(int)Define.Sound.Master].outputAudioMixerGroup =
                ResourceUtil.Load<AudioMixerGroup>("SoundMixer[Master]");
