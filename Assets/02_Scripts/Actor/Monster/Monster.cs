...
namespace Apis
{
    ...
    public partial class Monster : Actor, IRecognition, IMovable, IPoolObject
    {
        ...
        [HideIf("isStatLoadFromDataTable")] public MonsterDataType MonsterData;
        ...
        protected override void Awake()
        {
            ...
            // 현재는 모든 피해(CurHP가 줄어드는 Event)에 대하여  Gauge Recover 작동하도록 해둠.
        ...
        {
            if (isStatLoadFromDataTable) InitMonsterData(monsterDataType);
            CurHp = MaxHp;
        ...
        protected override void OnHitReaction(EventParameters eventParameters)
        {
            ...
            var knockBackData = GetKnockBackData(eventParameters);
