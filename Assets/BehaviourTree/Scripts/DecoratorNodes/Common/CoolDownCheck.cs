...
namespace Apis.BehaviourTreeTool
{
    ...
    {
        [InfoBox("쿨타임은 매번 최소, 최대중 랜덤으로 적용")] [PropertySpace(30)] [LabelText("최소 쿨타임")]
        public float cdMin;
        ...
        {
            if (startTime < 0 || startTime + cooldown < Time.time) return CheckChild;
        ...
        public override void Init()
        {
            ...
            if (startCD) startTime = Time.time;
