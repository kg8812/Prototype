...
namespace Apis.Components
{
    ...
    public class Trigger : MonoBehaviour
    {
        ...
        private void Awake()
        {
            _triggerActivates = new List<ITriggerActivate>();
        ...
        public void OnTriggerExit2D(Collider2D col)
        {
            ...
            if (actorCollisionHandler != null &&
                actorCollisionHandler.PhysicsTransitionHandler.IgnoredList.Contains(this)) return;
        ...
        private void InitTrigger()
        {
            ...
            if (!IsCanTriggered()) _col.enabled = false;
        }

        private bool CheckPreTriggers()
        {
        ...
        public void ActivateTrigger()
        {
            ...
            if (useFade)
            {
                ...
                {
                    foreach (var trigger in _triggerActivates) trigger.Activate();
