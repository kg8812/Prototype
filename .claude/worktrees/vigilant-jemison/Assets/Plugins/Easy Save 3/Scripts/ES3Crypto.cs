...
namespace ES3Internal
{
    public static class ES3Hash
    {
        ...
        public static string SHA1Hash(string input)
        {
            ...
            {
                return Encoding.UTF8.GetString(sha1.ComputeHash(Encoding.UTF8.GetBytes(input)));
            }
        }
#endif
    }
    ...
    public class UnbufferedCryptoStream : MemoryStream
    {
        ...
        private readonly EncryptionAlgorithm alg;
        private readonly int bufferSize;
        private bool disposed;
        private readonly string password;

        public UnbufferedCryptoStream(Stream stream, bool isReadStream, string password, int bufferSize,
