        ...
        public override object Read(ES3Reader reader)
        {
            ...
            while (true)
            {
                ...
                while (true)
                {
                    ...
                    ReadICollection(reader, items, elementType);
                    length2++;
            ...
            var array = ES3Reflection.ArrayCreateInstance(elementType.type, new[] { length1, length2, length3 });
