...
public class ActionNodeWindow : EditorWindow
{
    ...
    private void OnGUI()
    {
        ...
        var path = "Assets/BehaviourTree/Scripts/ActionNodes/" + className;
        ...
        if (GUILayout.Button("Create New Script"))
        {
            ...
            {
                var templatePath = "Assets/BehaviourTree/Templates/ActionNodeTemplate.txt";
    ...
    public void Init(string className)
    {
        ...
        {
            var idx = className.IndexOf("ActionNode", StringComparison.Ordinal);
