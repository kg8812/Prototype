...
이 프로젝트는 Unity에서 게임을 개발할 때 기본적으로 사용하는 공통 스크립트와 기능들을 정리한 프로젝트입니다.

프로젝트마다 반복적으로 구현되는 시스템을 하나의 베이스 프로젝트로 구성하여, 개발 초기 작업을 줄이고 일관된 구조로 개발을 진행할 수 있도록 했습니다.

<br/><br/>

## 프로젝트 목표

- Unity 프로젝트에서 반복적으로 사용하는 기능을 공통화
- 재사용 가능한 구조 구축
- 유지보수성과 확장성을 고려한 설계
- 실제 게임 프로젝트에서 검증한 구조를 지속적으로 개선
